...
if test -f ${DESTDIR}/data/app/httpd/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/data/app/httpd/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/data/app/httpd/bin/apu-1-config
else
...
test -n "/data/app/httpd/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/data/app/httpd/build"
